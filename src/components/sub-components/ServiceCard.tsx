...
const ServiceCard = ({ data }: { data: { tittle: string, desc: string } }) => {
    ...
    return (
        <div className="bg-[#262020] rounded-xl hover:-translate-y-3 duration-300 py-[40px] px-[26px] flex flex-col justify-center items-center text-center">
            ...
            <h1 className="mt-[25px] mb-[10px] text-[22px] poppins-bold">{data.tittle}</h1>
